...
// 完整历史 KV 主数据面从本轮开始固定到独立的 KV_MAIN_WINDOW，
// 不再驻留 ACCEL_SHARED。
#define RUNTIME_KV_MAIN_WINDOW_PHYS        0x1c410000u
#define RUNTIME_KV_MAIN_WINDOW_UNC         0xbc410000u
#define RUNTIME_KV_MAIN_WINDOW_SIZE        0x000a0000u

#define RUNTIME_KEY_CACHE_MAIN_REGION_PHYS 0x1c410000u
#define RUNTIME_KEY_CACHE_MAIN_REGION_UNC  0xbc410000u
#define RUNTIME_KEY_CACHE_MAIN_REGION_SIZE 0x00050000u

#define RUNTIME_VALUE_CACHE_MAIN_REGION_PHYS 0x1c460000u
#define RUNTIME_VALUE_CACHE_MAIN_REGION_UNC  0xbc460000u
#define RUNTIME_VALUE_CACHE_MAIN_REGION_SIZE 0x00050000u

// 当前阶段先冻结“data/scale 二级子区必须存在”的结构，
// scale 子区的精确边界与容量待量化实验结论后再回填。
#define RUNTIME_KEY_CACHE_MAIN_DATA_PHYS    RUNTIME_KEY_CACHE_MAIN_REGION_PHYS
#define RUNTIME_KEY_CACHE_MAIN_DATA_UNC     RUNTIME_KEY_CACHE_MAIN_REGION_UNC
#define RUNTIME_KEY_CACHE_MAIN_DATA_SIZE    RUNTIME_KEY_CACHE_MAIN_REGION_SIZE
#define RUNTIME_KEY_CACHE_MAIN_SCALE_PHYS   (RUNTIME_KEY_CACHE_MAIN_REGION_PHYS + RUNTIME_KEY_CACHE_MAIN_REGION_SIZE)
#define RUNTIME_KEY_CACHE_MAIN_SCALE_UNC    (RUNTIME_KEY_CACHE_MAIN_REGION_UNC + RUNTIME_KEY_CACHE_MAIN_REGION_SIZE)
#define RUNTIME_KEY_CACHE_MAIN_SCALE_SIZE   0x00000000u

#define RUNTIME_VALUE_CACHE_MAIN_DATA_PHYS  RUNTIME_VALUE_CACHE_MAIN_REGION_PHYS
#define RUNTIME_VALUE_CACHE_MAIN_DATA_UNC   RUNTIME_VALUE_CACHE_MAIN_REGION_UNC
#define RUNTIME_VALUE_CACHE_MAIN_DATA_SIZE  RUNTIME_VALUE_CACHE_MAIN_REGION_SIZE
#define RUNTIME_VALUE_CACHE_MAIN_SCALE_PHYS (RUNTIME_VALUE_CACHE_MAIN_REGION_PHYS + RUNTIME_VALUE_CACHE_MAIN_REGION_SIZE)
#define RUNTIME_VALUE_CACHE_MAIN_SCALE_UNC  (RUNTIME_VALUE_CACHE_MAIN_REGION_UNC + RUNTIME_VALUE_CACHE_MAIN_REGION_SIZE)
#define RUNTIME_VALUE_CACHE_MAIN_SCALE_SIZE 0x00000000u

// 旧 ACCEL_KV_SHARED 宏仅作迁移期占位，正式语义已废弃。
#define RUNTIME_ACCEL_KV_SHARED_PHYS   RUNTIME_KV_MAIN_WINDOW_PHYS
#define RUNTIME_ACCEL_KV_SHARED_UNC    RUNTIME_KV_MAIN_WINDOW_UNC
#define RUNTIME_ACCEL_KV_SHARED_SIZE   RUNTIME_KV_MAIN_WINDOW_SIZE
#define RUNTIME_ACCEL_KV_SHARED_DEPRECATED 1
